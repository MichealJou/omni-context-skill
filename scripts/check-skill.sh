...
required_scripts=(
  ...
  "scripts/setup-test-runtime.sh"
  "scripts/start-workflow.sh"
  "scripts/workflow-status.sh"
  "scripts/workflow-check.sh"
  "scripts/advance-stage.sh"
  "scripts/skip-stage.sh"
  "scripts/list-workflows.sh"
  "scripts/rules-pack-init.sh"
  "scripts/rules-pack-status.sh"
  "scripts/rules-pack-check.sh"
  ...
  "scripts/danger-check.sh"
  "scripts/record-dangerous-op.sh"
  "scripts/autopilot-run.sh"
  "scripts/autopilot-status.sh"
  "scripts/lib/omnicontext-l10n.sh"
  "scripts/lib/workflow-lib.sh"
  "scripts/lib/rules-pack-lib.sh"
  "scripts/lib/bundle-lib.sh"
...
required_templates=(
  ...
  "templates/workflow-registry.toml"
