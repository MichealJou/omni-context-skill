...
Tool adapter files should remain thin entry points, not independent knowledge systems.
...
Those should be defined by the OmniContext protocol and shared references.
