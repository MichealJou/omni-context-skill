...
- Scan likely project roots such as Git repositories and major app/service folders
...
Purpose:
- Intentionally add a new project knowledge area
...
Purpose:
- Create additional documents only when the workspace actually needs them
